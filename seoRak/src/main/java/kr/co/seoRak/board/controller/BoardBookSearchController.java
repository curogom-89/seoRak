...
@WebServlet("/BoardBookSearch.do")
public class BoardBookSearchController extends HttpServlet{
...
//		}
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/board/boardBookSearch.jsp");
