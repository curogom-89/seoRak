package kr.co.seoRak.search.controller;
...
//		int detail = Integer.parseInt(request.getParameter("detail"));
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/search/search.jsp");
	...
	public List<Book> searchBook(String title) {
		...
		try{
			...
			// 헤더 설정
			conn.setRequestProperty("X-Naver-Client-Id", "Je2yplmeKRtb8P7Le8e7");
			conn.setRequestProperty("X-Naver-Client-Secret", "W_ePCyBSim");
