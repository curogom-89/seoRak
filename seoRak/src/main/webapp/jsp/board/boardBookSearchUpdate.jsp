...
<body>
	...
	<form class="search-form" action='<c:url value="http://localhost:8000/seoRak/BoardBookSearchupdate.do"/>'>
                 	...
                 	%>
                 	  <tr>
                        ...
                        <!-- http://localhost:8000/seoRak/jsp/myListWrite.jsp -->
                        	<a href="http://localhost:8000/seoRak/boardupdate.do?title=<%= b.getTitle() %>&publisher=<%= b.getPublisher() %>&author=<%= b.getAuthor() %>&img=<%= b.getImage() %>&link=<%= b.getLink() %>&isbn=<%= b.getIsbn() %> ">
                        		<%= b.getTitle() %>
                        	</a>
                        </td>
