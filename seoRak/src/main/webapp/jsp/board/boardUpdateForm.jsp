...
<body>
	...
	<div>
		<form
			action="/seoRak/jsp/boardupdate.do?cover=<%=img%>&link=<%=link%>&isbn="
			<%=isbn%>" id="boardupdateForm" method="post">
			<table>
				<tr>
				...
				<tr>
					<td rowspan="4"><img name="cover" id="cover" src="<%=img%>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3"><textarea name="content" id="content"
							cols="110" rows="10">${board.boardContent}</textarea></td>
				</tr>
			</table>
			<hr>
