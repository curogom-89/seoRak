...
<%@include file="../includeBar/topList.jsp"%>
	...
	<hr>
	<div>
		<form action="/seoRak/boardwriter.do?cover=<%= img %>&link=<%= link %>&isbn="<%= isbn %>" method="post" id="writeForm">
			<table>
				<tr>
					...
					<input type="hidden" size="0" value="${board.boardNo}"></td>
				...
				<tr>
					<td rowspan="5" >
						<img name="boardBookCover" src="<%= img%>">
					</td>
				</tr>
				<tr>
					<td><input type="text" name="boardBookTitle" id="book" size="100"
						placeholder="책 제목" value="<%= title%>"></td>
				</tr>
				<tr>
					<td><input type="text" name="boardBookPublisher" id="publisher" size="100"
						placeholder="출판사" value="<%= publisher %>"></td>
				</tr>
				<tr>
					<td><input type="text" name="boardBookAuthor" id="author" size="100"
			...
			<button name="btn1" type="button" id="btn1"><a href="<c:url value='/boardlist.do'/>">목록으로</a></button>
