...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>   
	...
	<ul>
		...
		<li><a href="<c:url value='http://localhost:8000/seoRak/myInfo.do'/>">home</a></li>
		<c:choose>
...
<form class="totobar" name="mForm" action='<c:url value="http://localhost:8000/seoRak/topsearch.do"/>'>
	<ul class="menu">
		<li><a href="#" class="active">Home</a></li>
		<li><a href="<c:url value='http://localhost:8000/seoRak/myInfo.do'/>">마이페이지</a></li>
		<li><a href="<c:url value='http://localhost:8000/seoRak/boardlist.do'/>">게시판</a></li>
		<li><a href="<c:url value='http://localhost:8000/seoRak/BestSellerRanking.do'/>">랭킹</a></li>
		<li>
			<a href="#">
